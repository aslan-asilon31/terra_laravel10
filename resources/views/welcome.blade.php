    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">
                Suktura by Aslan <i class='bx bxs-home-alt-2'></i>
            </a>
        ...
        <section class="home section" id="home">
            <div class="home__container container grid">
                ...
                <div class="home__images">
                    ...
                    <div class="home__img">
                        <img src="{{ asset('frontend/img/home.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="popular__container swiper">
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            <img src="{{ asset('frontend/img/popular1.jpg') }}" alt="" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            <img src="{{ asset('frontend/img/popular2.jpg') }}" alt="" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            <img src="{{ asset('frontend/img/popular3.jpg') }}" alt="" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            <img src="{{ asset('frontend/img/popular4.jpg') }}" alt="" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            <img src="{{ asset('frontend/img/popular5.jpg') }}" alt="" class="popular__img">
            ...
            <div class="value__container container grid">
                <div class="value__images">
                    ...
                    <div class="value__img">
                        <img src="{{ asset('frontend/img/value.jpg') }}" alt="">
                    </div>
                </div>
